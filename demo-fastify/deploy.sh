...
cluster="demo-fastify-${stage}-cluster"
service="demo-fastify-${stage}-service"

commitTag="${account}.dkr.ecr.us-east-1.amazonaws.com/demo-fastify:${GITHUB_SHA}"
latestTag="${account}.dkr.ecr.us-east-1.amazonaws.com/demo-fastify:latest"
